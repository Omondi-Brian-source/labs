    ...
    <section className="py-16 md:py-32">
      <div className="mx-auto max-w-5xl space-y-12 px-6">
        <div className="relative z-10 grid items-center gap-4 md:grid-cols-2 md:gap-12">
          <h2 className="text-4xl font-semibold">Curated Works</h2>
          <p className="max-w-sm sm:ml-auto">
            Empower your business with workflows that adapt to your needs,
            whether you prefer modern applications or a AI Agents interface.
          </p>
        </div>
